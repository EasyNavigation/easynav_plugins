...
class VffControllerReconfigureTest : public ::testing::Test
{
protected:
  void SetUp() override
  {
...
TEST_F(VffControllerReconfigureTest, InitializeTwiceOnSameNodeDoesNotThrow)
{
  auto node = rclcpp_lifecycle::LifecycleNode::make_shared("vff_controller_reconfigure_test");

  auto plugin1 = std::make_shared<easynav::VffController>();
